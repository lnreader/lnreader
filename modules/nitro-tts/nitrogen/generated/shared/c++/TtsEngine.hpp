...
namespace margelo::nitro::nitrotts {
  ...
  /**
   * A struct which can be represented as a JavaScript object (TtsEngine).
   */
  struct TtsEngine final {
  public:
  ...
  public:
    TtsEngine() = default;
    explicit TtsEngine(std::string name, std::string label): name(name), label(label) {}

  public:
    friend bool operator==(const TtsEngine& lhs, const TtsEngine& rhs) = default;
  };
...
namespace margelo::nitro {
  ...
  // C++ TtsEngine <> JS TtsEngine (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrotts::TtsEngine> final {
    static inline margelo::nitro::nitrotts::TtsEngine fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrotts::TtsEngine(
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrotts::TtsEngine& arg) {
