...
export interface StringMap {
  ...
  'readerScreen.bottomSheet.translation': 'string';
  'readerScreen.bottomSheet.translationEnableDescription': 'string';
  'readerScreen.bottomSheet.translationSettings': 'string';
  'readerScreen.bottomSheet.translationRedo': 'string';
  'readerScreen.bottomSheet.translationRegex': 'string';
  'readerScreen.bottomSheet.translationDisabledNotice': 'string';
  ...
  'translationSettings.general': 'string';
  'translationSettings.enable': 'string';
  'translationSettings.enableDescription': 'string';
  'translationSettings.parallelMode': 'string';
  'translationSettings.sourceLanguage': 'string';
  'translationSettings.targetLanguage': 'string';
  'translationSettings.mainProvider': 'string';
  'translationSettings.provider': 'string';
  'translationSettings.defaultPrompt': 'string';
  'translationSettings.providerCredentials': 'string';
  'translationSettings.useCommunityGooglePaKey': 'string';
  'translationSettings.useCommunityGooglePaKeyDescription': 'string';
  'translationSettings.apiKey': 'string';
  'translationSettings.apiKeyPlaceholder': 'string';
  'translationSettings.noKeySet': 'string';
  'translationSettings.geminiModel': 'string';
  'translationSettings.openaiModel': 'string';
  'translationSettings.openaiEndpoint': 'string';
  'translationSettings.googleFreeNote': 'string';
  'translationSettings.customPrompts': 'string';
  'translationSettings.addPrompt': 'string';
  'translationSettings.editPrompt': 'string';
  'translationSettings.noPrompts': 'string';
  'translationSettings.promptName': 'string';
  'translationSettings.promptContent': 'string';
  'translationSettings.prompt': 'string';
  'translationSettings.promptNone': 'string';
  'translationSettings.promptGlobalDefault': 'string';
  'translationSettings.regexRules': 'string';
  'translationSettings.addRule': 'string';
  'translationSettings.editRule': 'string';
  'translationSettings.rulePattern': 'string';
  'translationSettings.ruleReplacement': 'string';
  'translationSettings.ruleEnabled': 'string';
  'translationSettings.ruleRemoveText': 'string';
  'translationSettings.noRules': 'string';
  'translationSettings.providers.google_pa': 'string';
