...
export interface StringMap {
  ...
  'historyScreen.purgeWarning.zero': 'string';
  'historyScreen.purgeWarning.one': 'string';
  'historyScreen.purgeWarning.other': 'string';
  'historyScreen.removedFromLibrarySuffix.zero': 'string';
  'historyScreen.removedFromLibrarySuffix.one': 'string';
  'historyScreen.removedFromLibrarySuffix.other': 'string';
  'historyScreen.chapterLinePresent.one': 'string';
  'historyScreen.chapterLinePresent.other': 'string';
  'historyScreen.chapterLineAbsent': 'string';
  'historyScreen.unattributableDownloads.one': 'string';
