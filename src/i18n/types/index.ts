...
export interface StringMap {
  ...
  'translationSettings.region': 'string';
  'translationSettings.requestUrl': 'string';
  'translationSettings.headers': 'string';
  'translationSettings.bodyTemplate': 'string';
  'translationSettings.responsePath': 'string';
  'translationSettings.categoryFreeNoKey': 'string';
  'translationSettings.categoryApiKey': 'string';
  'translationSettings.categorySelfHosted': 'string';
  'translationSettings.categoryEscapeHatch': 'string';
  'translationSettings.test': 'string';
  'translationSettings.testDesc': 'string';
  'translationSettings.testRunning': 'string';
  'translationSettings.testSuccess': 'string';
  'translationSettings.testFailed': 'string';
  'translationSettings.queue': 'string';
  'translationSettings.chunkSize': 'string';
  'translationSettings.chunkSizeDesc': 'string';
  'translationSettings.chunkSizeHint': 'string';
  'translationSettings.requestDelay': 'string';
