...
export const clearNovelTranslationCache = (
  novelId: number,
  chapters: any[],
): void => {
  try {
...
const translateText = async (
  ...
  if (textMemoryCache.has(cacheKey)) {
